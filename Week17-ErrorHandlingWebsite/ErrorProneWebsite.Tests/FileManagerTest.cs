...
namespace ErrorProneWebsite.Tests
{
    ...
    {
        private const string TEST_FILE_PATH = @"C:\Users\eseos\Documents\CTEC2902GitLabs_2\Week17-ErrorHandlingWebsite\ErrorProneWebsite.Tests\TestContent\TestContent.txt";
